...
import { Calendar, MapPin, Users, Trophy, Clock, CheckCircle2, Sparkles, Crown, Zap, Star } from 'lucide-react'
...
const ChessBooking = () => {
  ...
  // Professional chess tournament ticket types with enhanced styling
  const ticketTypes = [
    {
      id: 'spectator',
      name: 'Spectator Ticket',
      description: 'General admission to watch the tournament',
      price: 50,
      features: [
        'Access to tournament hall',
        'Live game viewing',
    ...
    },
    {
      ...
      description: 'Enhanced viewing experience with better seating',
      price: 100,
      features: [
        'Priority seating near boards',
        'Access to premium viewing area',
        'Professional commentary access',
    ...
    },
    {
      ...
      features: [
        ...
        'Signed tournament program',
        'Exclusive VIP lounge access',
        'Professional analysis session'
      ],
      color: '#7C3AED',
      lightColor: '#8B5CF6',
      icon: Crown,
    ...
    },
    {
      ...
      description: 'For competing in the tournament',
      price: 150,
      features: [
        'Tournament entry',
  ...
  const handleBooking = async () => {
    ...
    try {
      // Create booking for chess tournament
      ...
      const { data } = await axios.post('/api/sports/booking/create', {
        ...
        customAmount: totalAmount  // Pass custom amount for chess ticket pricing
      }, {
  ...
  return (
    <div className="min-h-screen px-6 md:px-16 lg:px-40 pt-30 md:pt-40 pb-20 relative overflow-hidden">
      ...
      {/* Animated background chess board pattern */}
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute inset-0" style={{
          backgroundImage: `repeating-linear-gradient(0deg, transparent, transparent 50px, rgba(255,255,255,0.03) 50px, rgba(255,255,255,0.03) 100px),
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-purple-500/20 border border-purple-500/50 rounded-full mb-6 backdrop-blur-sm shadow-lg shadow-purple-500/20"
          >
            <motion.div
            ...
            <span className="text-sm font-semibold text-purple-400 uppercase tracking-wider">Chess Tournament</span>
          ...
          <motion.h1
            ...
            className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-pink-400 via-purple-500 to-pink-500 bg-clip-text text-transparent leading-tight"
            style={{
          ...
          >
            Professional Chess Tournament - Reserve your tickets now
          </motion.p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              className="bg-gradient-to-br from-gray-900/80 via-gray-900/60 to-gray-900/80 backdrop-blur-xl rounded-3xl p-6 border border-gray-800/50 sticky top-32 shadow-2xl shadow-purple-500/10 hover:shadow-purple-500/20 transition-all duration-500"
            >
              {/* Event Image */}
              {event.image && (
                <motion.div
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 opacity-0 group-hover:opacity-100">
                    <p className="text-white font-semibold text-sm">Professional Chess Tournament</p>
                  </div>
                </motion.div>
              )}
              ...
              <div className="space-y-5">
                ...
                >
                  <motion.div
                    whileHover={{ scale: 1.2, rotate: 5 }}
                    className="p-2 rounded-lg bg-pink-500/20 group-hover:bg-pink-500/30 transition-colors"
                  >
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white font-semibold">Full Day Tournament</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white font-semibold">Professional Tournament</p>
                  </div>
                </motion.div>
              </div>
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <motion.div
                        ...
                        transition={{ duration: 0.3 }}
                        className="flex items-center justify-between pt-4 pb-2 border-t-2 border-purple-500/30 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-4"
                      >
              ...
              <AnimatePresence>
                {selectedTicket && (
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-gray-900/80 via-gray-900/60 to-gray-900/80 backdrop-blur-xl rounded-3xl p-8 border-2 border-purple-500/30 mb-8 shadow-2xl shadow-purple-500/10 overflow-hidden relative"
                  >
                    {/* Animated background */}
                    <div
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/20 border border-purple-500/50">
                          ...
                          <span className="text-xs text-purple-400 font-semibold">Max 10</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        >
                          <input
                            ...
                            className="w-24 h-14 text-center text-3xl font-extrabold bg-gradient-to-br from-gray-800 to-gray-900 border-2 rounded-xl py-2 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                            style={{
